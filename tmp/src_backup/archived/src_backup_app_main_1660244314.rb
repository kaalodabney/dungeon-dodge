...
class Game
  ...
  def tick
    ...
    if state.tick_count.zero?
      outputs.static_sprites << @map.layers['Void'].sprites
      outputs.static_sprites << @map.layers['Ground'].sprites
      # outputs.static_sprites << @map.layers['Entities'].sprites
      outputs.static_sprites << @map.layers['Collision'].sprites
      outputs.static_sprites << @map.layers['Decoration'].sprites
      # outputs.static_sprites << @map.layers.select(&:visible?).each do |l|
      #   l.sprites
      # end
    end
