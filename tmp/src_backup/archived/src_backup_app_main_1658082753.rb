...
def spriteAnimations args
   ...
   args.state.players.each do |p|
      p.spriteAnim == "idle" ? p.sprite = "sprites/dc16pp/heroes/knight/knight_idle_anim_f#{p.spriteID}.png"
      p.spriteAnim == "walk" ? p.sprite = "sprites/dc16pp/heroes/knight/knight_walk_anim_f#{p.spriteID}.png"
   end
end
