...
class Game
  ...
  def initialize args
    ...
    @enemyArray  = [Enemy.new(args, 2, "bat", 100, 600, 75, 75),
                    ...
                    Enemy.new(args, 4, "bat", 300, 600, 50, 50),
                    Enemy.new(args, 5, "bat", 400, 550, 50, 50),
                    Enemy.new(args, 6, "bat", 500, 600, 50, 50),
                    Enemy.new(args, 7, "slime", 200, 100, 85, 85),
                    Enemy.new(args, 8, "goblin", 900, 400)]
  ...
  def entityUpdate args
    ...
    @enemyArray.each do |e|
      ...
      e.dx = 0
      e.dy = 0
      e.colRect.x, e.colRect.y = e.x, e.y

      e.movement(playerArray[0], playerArray + enemyArray)
    end
    ...
    @playerArray.each do |p|
      ...
      p.movement(@keypressed, @enemyArray)
