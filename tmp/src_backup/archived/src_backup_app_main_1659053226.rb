...
class Game
  attr_accessor :player, :enemyArray, :keypressed, :args
  def initialize args
    @args = args
    @keypressed = Array.new(0)
    @player = Player.new(id: 1, type: "player", x: 590, y: 250, w:75, h:75)
  ...
  def detectInput args
    ...
    if 8args.inputs.keyboard.key_down.c
