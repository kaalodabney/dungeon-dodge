...
def tick args
  ...
  args.player.moveSpeed = 5
  if args.inputs.up
    args.state.player.spriteAnim = "walk"; args.state.keypressed = "up"d
    args.state.player.y += args.player.moveSpeed
    upDownPressed = true
  ...
  if args.inputs.right
    ...
    args.state.player.x += args.player.moveSpeed
