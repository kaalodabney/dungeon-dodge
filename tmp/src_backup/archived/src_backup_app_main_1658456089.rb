...
def init args
  ...
  args.state.enemies ||= [{  
    ...
    w: 100,
    h:  100,
    colRect: { x: 800, y: 310 + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 50 + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 100 + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 200 + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 350 + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
...
def entityController args
  ...
  args.state.players.each do |p|
    args.outputs.labels << [10, 60, "[colRect.x, p.x]: First Left input (before collision check): #{p.debugVal3}"]
    args.outputs.labels << [10, 40, "[colRect.x, p.x]: keypressed array includes left (in playerCollision): #{p.debugVal1} (colRect.x should be 585, p.xx should be 590)"]
    args.outputs.labels << [10, 20, "left input count (in playerCollision): #{p.debugVal4}"]
