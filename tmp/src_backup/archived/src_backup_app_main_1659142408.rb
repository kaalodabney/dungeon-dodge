...
class Game
  attr_gtk
  attr_accessor :player, :enemyArray, :keypressed, :bombArray, :bombCount
  def defaults
    @keypressed ||= Array.new(0)
    @player ||= Player.new(id: 1, type: "player", x: 590, y: 250, w:75, h:75, movespeed: 6)
    @enemyArray  ||= [Enemy.new(id: 2, type: "bat", x: 100, y: 600, movespeed: 3),
                    Enemy.new(id: 3, type: "bat", x: 1100, y: 600, w:75, h:75),
                    Enemy.new(id: 4, type: "bat", x: 300, y: 600, movespeed: 2),
                    Enemy.new(id: 5, type: "bat", x: 400, y: 550, movespeed: 4),
                    Enemy.new(id: 6, type: "bat", x: 500, y: 600),
                    Enemy.new(id: 7, type: "bat", x: 900, y: 400),
                    Enemy.new(id: 8, type: "bat", x: 200, y: 100, w:55, h:55),
                    Enemy.new(id: 9, type: "bat", x: 200, y: 100, w:55, h:55),
                    Enemy.new(id: 10, type: "bat", x: 200, y: 90, w:90, h:90),
                    Enemy.new(id: 11, type: "bat", x: 201, y: 100, w:55, h:55)                  
                  ]
  ...
  def detectInput
    ...
    if inputs.keyboard.key_down.space
      ...
      @bombCount += 1
      @bombArray.push(Bomb.new(id: @bombCount, x: @player.x, y: @player.y))
      #launchBomb
    end
  ...
  def spriteAnimations
    ...
    entities.each do |e|
      ...
      if e.type == "player"
        ...
        frameCount = 10
        frameSpeed = 10
        e.sprite = "sprite/dc16pp/enemies/props/bomb_anim_f#{e.spriteID}.png"
      end
  ...
  def viewOutput
    ...
    @bombArray.each do |b|
        outputs.sprite << { x: b.x, y: b.y, w: b.w, h: b.h, path: b.sprite}
    end
