...
def init args
 ...
 # args.state.player.spriteWalkArr ||= ["sprites/dc16pp/heroes/knight/knight_run_anim_f0.png", "sprites/dc16pp/heroes/knight/knight_run_anim_f1.png", "sprites/dc16pp/heroes/knight/knight_run_anim_f2.png", "sprites/dc16pp/heroes/knight/knight_run_anim_f3.png", "sprites/dc16pp/heroes/knight/knight_run_anim_f4.png", "sprites/dc16pp/heroes/knight/knight_run_anim_f5.png"]
  ...
  # initialize state.enemies variables

  args.state.enemies ||= {args.state.enemies.x: 50, args.state.enemies.y: 50, args.state.enemies.width: 50, args.state.enemies.height: 50, args.state.enemies.id: 1 }
...
def spriteAnimations args
   ...
   args.state.player.spriteAnim == "idle" ? args.state.player.sprite =  "sprites/dc16pp/heroes/knight/knight_idle_anim_f#{spriteID}.png" : nil
   args.state.player.spriteAnim == "walk" ? args.state.player.sprite =  "sprites/dc16pp/heroes/knight/knight_run_anim_f#{spriteID}.png" : nil
