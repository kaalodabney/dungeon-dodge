...
class Enemy < Entity
    ...
    def enemyCollision e
        collisionRL, collisionUD, collisionBoth = false

        @colRect.x += @dx
        collisionRL = @colRect.intersect_rect? e.colRect
        @colRect.x = @x

        @colRect.y += @dy
        collisionUD = @colRect.intersect_rect? e.colRect
        @colRect.y = @y

        @colRect.y += @dy
        @colRect.x += @dy
        collisionBoth = @colRect.intersect_rect? e.colRect
        @colRect.y = @y
        @colRect.x = @x


        @col = collisionRL || collisionUD || collisionBoth
        #@col = false if e.id == @id
