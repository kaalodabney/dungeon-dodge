...
def tick args
  ...
  #Player Input
  args.inputs.keyboard.up ? (args.state.player.spriteAnim = "walk"; args.state.keypressed = "up") : nill
  ...
  #Key pressed label
  args.outputs.labels << [640 - 20, 360 - 20, "Key Pressed: #{args.state.keypressed}"]
