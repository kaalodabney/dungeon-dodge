...
def playerMovement args
  ...
  args.state.players.each do |p|
    ...
    upPressed && p.collisionDirection = "down"    ? p.collision = false : nil
    downPressed && p.collisionDirection = "up"    ? p.collision = false : nil
    rightPressed && p.collisionDirection = "left" ? p.collision = false : nil
    leftPressed && p.collisionDirection = "right" ? p.collision = false : nil
