...
def tick args
  ...
  args.state.player.sprite.src ||= nil
  ...
  args.outputs.labels << [10, 680, "Sprite Src: #{args.state.player.sprite.src[spriteID]}"]
  args.outputs.labels << [10, 660, "SpriteID: #{args.state.player.sprite}"]
