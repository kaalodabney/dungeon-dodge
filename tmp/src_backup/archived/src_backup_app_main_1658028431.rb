...
def tick args
  ...
  #set player sprite depending on current animation playing
   args.state.player.spriteAnim == "idle" ? args.state.player.sprite =  args.state.player.spriteSrcArr[args.state.player.spriteID] : nil
   args.state.player.spriteAnim == "walk" ? args.state.player.sprite =  args.state.player.spriteSrcArr[args.state.player.spriteID] : nil
