...
def init args
  ...
  args.state.enemies ||= [{  
    ...
    w: 100,
    h:  100,
    colRect: { x: enemyLineX + 100, y: enemyLineY + 100, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h:  100,
    colRect: { x: enemyLineX + 200, y: enemyLineY + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h:  100,
    colRect: { x: enemyLineX + 300, y: enemyLineY + 300, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h:  100,
    colRect: { x: enemyLineX + 400, y: enemyLineY + 400, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
