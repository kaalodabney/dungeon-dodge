...
class Game
  ...
  def initialize args
    ...
    @player = Player.new(args, 1, 590, 250, w:75, h:75)
    @enemyArray  = [Enemy.new(args, 2, "bat", 100, 600, movespeed: 5),
                    Enemy.new(args, 3, "bat", 1100, 600, w:75, h:75),
                    Enemy.new(args, 4, "goblin", 300, 600, w:50, h:50),
                    Enemy.new(args, 5, "goblin", 400, 550, w:50, h:50),
                    Enemy.new(args, 6, "goblin", 500, 600, w:50, h:50),
                    Enemy.new(args, 7, "goblin", 900, 400),
                    Enemy.new(args, 8, "slime", 200, 100, w:55, h:55),
                    Enemy.new(args, 9, "slime", 200, 100, w:55, h:55),
                    Enemy.new(args, 10, "slime", 200, 90, w:90, h:90),
                    Enemy.new(args, 11, "slime", 201, 100, w:55, h:55)                  
                  ]
