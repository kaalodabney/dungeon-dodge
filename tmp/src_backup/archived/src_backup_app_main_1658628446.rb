...
class Game
  def initialize args
    ...
    @enemyArray  = [Enemy.new(args, 2, "bat", 75, 400, 75, 75),
                    Enemy.new(args, 3, "bat", 200, 400, 75, 75),
                    Enemy.new(args, 4, "bat", 300, 400, 50, 50),
                    Enemy.new(args, 5, "bat", 400, 400, 50, 50),
                    Enemy.new(args, 6, "bat", 500, 400, 50, 50),
                    Enemy.new(args, 7, "slime", 600, 400, 50, 50),
                    Enemy.new(args, 8, "goblin", 900, 400, 100, 100)]
