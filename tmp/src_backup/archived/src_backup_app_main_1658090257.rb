...
def playerMovement args
  ...
  args.state.players.each do |p|
    ...
    if args.inputs.right 
      p.collisionDirection == "left" ? (p.collision = false; p.collisionDirection = "") : nil
      p.dx = moveSpeed
    ...
    if args.inputs.left 
      p.collisionDirection == "right" ? (p.collision = false; p.collisionDirection = "") : nil
      p.dx = moveSpeed
    ...
    if args.inputs.up 
      p.collisionDirection == "down" ? (p.collision = false; p.collisionDirection = "") : nil
      p.dy = moveSpeed
    ...
    if args.inputs.down 
      p.collisionDirection == "up" ? (p.collision = false; p.collisionDirection = "") : nil
      p.dy = moveSpeed
