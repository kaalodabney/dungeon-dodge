...
def actorController args
  ...
  args.state.players.each do |p|
    ...
    (upPressed && p.collisionDirection = "up" || downPressed && p.collisionDirection = "down" || rightPressed && p.collisionDirection = "right" || leftPressed && p.collisionDirection = "left") ? (p.collision = false; p.collisionDirection = "") : nil 
