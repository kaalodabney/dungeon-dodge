...
class Game
  ...
  def renderMap
    ...
    mapW = @map.width.to_i * @map.tilewidth.to_i / @zoom
    mapH = @map.height.to_i * @map.tileheight.to_i / @zoom
    outputs.sprites << [0 - @cameraFocusX.to_i , 0 - @cameraFocusY.to_i, mapW, mapH, :map]
  end
