...
def actorController args
  ...
  args.state.players.each do |p|
    ...
    upPressed && p.collisionDirection = "down"    ? (p.collision = false; p.collisionDirection = "") : nil
    downPressed && p.collisionDirection = "up"    ? (p.collision = false; p.collisionDirection = "") : nil
    rightPressed && p.collisionDirection = "left" ? (p.collision = false; p.collisionDirection = "") : nil
    leftPressed && p.collisionDirection = "right" ? (p.collision = false; p.collisionDirection = "") : nil
    ...
    args.state.enemies.each do |e| { p.collision = false ? e.collsion = false : nil} end
