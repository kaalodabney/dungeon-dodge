...
class Game
  ...
  def renderMap
    ...
    mapW = @map.width.to_i * @map.tilewidth.to_i
    mapH = @map.height.to_i * @map.tileheight.to_i
    outputs.sprites << [@cameraFocusX.to_i , @cameraFocusY.to_i, mapW, mapH, :map]
  end
...
def tick args
  ...
  args.outputs.sprites << [$game.cameraFocusX, $game.cameraFocusY, 1280*@zoom.to_i, 720*@zoom.to_i, :camera]
