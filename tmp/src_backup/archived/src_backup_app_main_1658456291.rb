...
def init args
  ...
  args.state.enemies ||= [{  
    ...
    w: 100,
    h:  100,
    colRect: { x: 800, y: 310 + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 50 + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 100 + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 200 + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 350 + 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
...
def entityController args
  ...
  args.state.players.each do |p|
    args.outputs.labels << [10, 65, "[colRect.x, p.x]: First Left input (before collision check): #{p.debugVal3}"]
    args.outputs.labels << [10, 45, "[colRect.x, p.x]: keypressed array includes left (in playerCollision): #{p.debugVal1} (colRect.x should be 585, p.xx should be 590)"]
    args.outputs.labels << [10, 25, "left input count (in playerCollision): #{p.debugVal4}"]
...
def viewOutput args
  ...
  args.state.enemies.each do |e|
    ...
    # }
    args.outputs.borders << [e.colRect.x, e.colRect.y, e.colRect.w, e.colRect.h]
  end
