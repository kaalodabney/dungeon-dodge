...
class Game
  ...
  def renderMap
    ...
    mapW = @map.width * @map.tilewidth * @zoom
    mapW = @map.height * @map.tileHeight * @zoom
    outputs.sprites << [0, 0, (@map.width.to_i * @map.tilewidth.to_i) * @zoom, (@map.height.to_i * @map.tilewidth.to_i) , :map]
  end
