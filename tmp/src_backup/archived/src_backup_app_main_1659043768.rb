...
class Game
  ...
  def initialize args
    ...
    @player = Player.new(args: args, id: id: 1, type: "player", x: 590, y: 250, w:75, h:75)
    @enemyArray  = [Enemy.new(args: args, id: 2, type: "bat", x: 100, y: 600, movespeed: 5),
                    ...
                    Enemy.new(args: args, id: 4, type: "goblin", x: 300, y: 600, w:50, h:50),
                    Enemy.new(args: args, id: 5, type: "goblin", x: 400, y: 550, w:50, h:50),
                    Enemy.new(args: args, id: 6, type: "goblin", x: 500, y: 600, w:50, h:50),
