class Entity
    ...
    def initialize id:, type:, x:, y:, w: 32, h: 32, movespeed:0, spriteAnim: "idle", spriteDir: "right"
        @id = id
        @type = type
        @x =  x
        @y =  y
...
class Player < Entity
    ...
    def initialize id:, type: "player", x:, y:, movespeed:3 
...
class Effect < Entity
    ...
    def initialize id: , type: , x: , y: , w: 125 , h: 125
        super(id: id, type: type, x: x, y: y, w: w, h: h)
