...
def spriteAnimations args
 ...
 args.state.enemies.each do |e|
  ...
  if e.spriteAnim = "idle"
    e.sprite = "sprites/dc16pp/enemies/goblin/goblin_idle_anim_f#{e.spriteID}.png" if enemyType = "goblin"
    e.sprite = "sprites/dc16pp/enemies/slime/slime_idle_anim_f#{e.spriteID}.png" if enemyType = "slime"
  end

  if e.spriteAnim = "walk"
    e.sprite = "sprites/dc16pp/enemies/goblin/goblin_run_anim_f#{e.spriteID}.png" if enemyType = "goblin"
    e.sprite = "sprites/dc16pp/enemies/slime/slime_run_anim_f#{e.spriteID}.png" if enemyType = "slime"
  end

  e.sprite = "sprites/dc16pp/enemies/flying creature/fly_anim_f#{e.spriteID}.png" if enemyType = "bat"
end
