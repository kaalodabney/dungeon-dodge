...
class Entity
  ...
  attr_accessor :type, :x, :y, :w, :h, :sprite, :spriteDir, :colRect, :col, :spriteID, :spriteAnim, :dx, :dy
...
class Player < Entity
  ...
  def initialize args, x, y, w=100, h=100
    ...
    @healthbarUI = {path: "sprites/dc16pp/ui/health_ui.png", x: x-15, y: y-25, w: 100, h: 20}
    @hearts = 4
    @enemyColArray = [] 
  end
end
