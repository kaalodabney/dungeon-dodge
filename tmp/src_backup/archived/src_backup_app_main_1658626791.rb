...
class Game
  def initialize args
    ...
    @playerArray = [Player.new(args, 1, 590, 250)]
    @enemyArray  = [Enemy.new(args, 2, "goblin", 100, 400),
                    Enemy.new(args, 3, "bat", 200, 400, 75, 75),
                    Enemy.new(args, 4, "bat", 300, 400, 75, 75),
                    Enemy.new(args, 5, "bat", 400, 400, 75, 75),
                    Enemy.new(args, 6, "slime", 500, 400, 75, 75),
                    Enemy.new(args, 7, "slime", 600, 400, 75, 75),
                    Enemy.new(args, 8, "slime-L", 900, 400, 200, 200)]
