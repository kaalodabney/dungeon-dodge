...
def init args
  ...
  args.state.enemies ||= [{  
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 50, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 100, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 200, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
    ...
    w: 100,
    h: 100,
    colRect: { x: 900, y: 360 - 350, w: 100, h: 100,},
    col: false,
    colDir: Array.new(0),
    dx: 0,
    dy: 0,
...
def entityController args
  ...
  args.state.players.each do |p|
    ...
    args.outputs.borders << [p.colRect.x, p.colRect.y, p.colRect.w, p.colRect.h, [255, 0, 0]]
    args.outputs.borders << [p.x, p.y, p.w, p.h]
  end
