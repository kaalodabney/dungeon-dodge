...
class Game
  ...
  def defaults
    ...
    @entityCount ||= 0
    @player ||= Player.new(id: @entityCount, type: "player", x: 1185, y: 545, movespeed: 3, zoom: @zoom)
    @entityCount += 1
    @entityArray  ||= [ @player,
                    Enemy.new(id: @entityCount, type: "bat", x: 100, y: 600, movespeed: 2, zoom: @zoom),
                    Enemy.new(id: @entityCount+1, type: "slime", x: 1100, y: 600, zoom: @zoom),
                    Enemy.new(id: @entityCount+2, type: "goblin", x: 300, y: 600, movespeed: 2, zoom: @zoom),
                    Enemy.new(id: @entityCount+3, type: "bat", x: 400, y: 550, movespeed: 2, zoom: @zoom),
                    Enemy.new(id: @entityCount+4, type: "slime", x: 500, y: 600, zoom: @zoom),
                    Enemy.new(id: @entityCount+5, type: "bat", x: 900, y: 400, zoom: @zoom),
                    Enemy.new(id: @entityCount+6, type: "goblin", x: 200, y: 100, zoom: @zoom),
                    Enemy.new(id: @entityCount+7, type: "bat", x: 200, y: 100, zoom: @zoom),
                    Enemy.new(id: @entityCount+8, type: "slime", x: 200, y: 90, zoom: @zoom),
                    Enemy.new(id: @entityCount+9, type: "bat", x: 201, y: 100, zoom: @zoom)                  
                  ]
    @entityCount += 10              
    @upPressed ||= false
    @downPressed ||= false
  ...
  def entityUpdate
    ...
    if (state.tick_count % 30) == 0 && @shift
      @entityArray.push(Bomb.new(id: @entityCount, x: @player.x, y: @player.y, zoom: @zoom))
      @entityCount += 1
    end
