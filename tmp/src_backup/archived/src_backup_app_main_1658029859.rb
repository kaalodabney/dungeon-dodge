...
def tick args
  ...
  #Player Input (tried with ternarries, only works with the last one for some reason)
  ...
  if args.inputs.keyboard.up
    ...
    args.state.player.spriteAnim = "right"; args.state.keypressed = "right"
  else
    args.state.player.spriteAnim = "idle"; args.state.keypressed = ""
  end
