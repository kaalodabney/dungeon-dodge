...
class Enemy < Entity
    ...
    def enemyCollision e
        ...
        collisionUD = false
        collisionBoth = false
        collisionRL = [@colRect.x-1 + @dx, @colRect.y-1, @colRect.w+2, @colRect.h+2].intersect_rect? e.colRect
        collisionUD = [@colRect.x-1, @colRect.y-1 + @dy, @colRect.w+2, @colRect.h+2].intersect_rect? e.colRect
        collisionBoth = [@colRect.x-1 +@dx, @colRect.y-1 + @dy, @colRect.w+2, @colRect.h+2].intersect_rect? e.colRect
    ...
    def enemyMovement p, enemyArray
        ...
        enemyCollision(p)
        enemyArray.each { |e| enemyCollision(e) unless e.id == @id}
