...
def actorController args
  ...
  args.state.players.each do |p|
    ...
    (upPressed && p.collisionDirection = "down" || downPressed && p.collisionDirection = "up" || rightPressed && p.collisionDirection = "left" || leftPressed && p.collisionDirection = "right") ? (p.collision = false; p.collisionDirection = "") : nil 
